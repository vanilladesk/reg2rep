...
# modify one item
echo "-------------------------------"
echo "Update 'item3' 'key1' to value 'value1111'"
ruby reg2rep.rb -o ~/reg2rep.log --update $DBDOMAIN item3 "key1:value1111" --id $AWS_ACCESS_KEY --secret $AWS_SECRET_KEY --address $AWS_ADDRESS
...
ruby reg2rep.rb -o ~/reg2rep.log --list $DBDOMAIN items --id $AWS_ACCESS_KEY --secret $AWS_SECRET_KEY --address $AWS_ADDRESS
